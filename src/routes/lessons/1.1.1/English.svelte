...
<hr>
<p class="foot-note"><span class="pali">Bahujanahitasuttaṃ</span>: bahu+jana+hita—many + people + benefit, welfare</p>
<p class="foot-note">The translations in these English headings to the Suttas do not directly resemble the title of the respective Suttas. They rather try to indicate the contents in order to give the reader a quick idea about it. The footnotes here will give the direct and literal translation. The word <span class="pali">sutta</span> remains untranslated. Its meaning is: <em>thread, text, line of…</em>&ndash;and relates in general to the narrational dialogues, mainly collected in the Sutta-piṭaka.</p> -->
